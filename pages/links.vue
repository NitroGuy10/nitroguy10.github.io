<script lang="ts" setup>
  ...
  const socialsToInclude = ["youtube", "soundcloud", "spotify", "github", "bluesky", "musicBluesky", "instagram", "website", "email", "twitter", "musicTwitter"];
...
<template>
  <div id="links" class="mx-auto w-[200px] sm:w-[400px] md:w-[700px] flex flex-wrap justify-center gap-4 md:gap-6 mt-4">
    <div v-for="social of socials">
      <NuxtLink :to="social.link" class="no-underline">
        <div :class="`mb-2 text-center w-48 h-32 rounded-xl border-b-4 hover:border-b-2 hover:h-[126px] hover:mt-[2px] border-zinc-600 transition-all ${social.type !== 'Email' && 'active:border-b-0 active:h-[124px] active:mt-1'}`" :style="`background: ${social.color}`">
