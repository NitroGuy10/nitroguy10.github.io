<template>
  <div id="favorite-games">
    ...
    <ul class="list-disc leading-relaxed ml-16">
      <li><NuxtLink to="https://youtu.be/hwigKZTXHZE" class="underline">Seven Lions - Only Now (feat. Tyler Graves)</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/YalpWKnlWkQ" class="underline">Rusherz - Breakthrough</NuxtLink></li>
    </ul>
    ...
    <ul class="list-disc leading-relaxed ml-16">
      <li><NuxtLink to="https://youtu.be/ff10T5uo8Dk" class="underline">KERO - Flora</NuxtLink> (my <em>favorite song of 2022</em>)</li>
      <li><NuxtLink to="https://youtu.be/B6LLXF8RRNo" class="underline">Distayne - Halo</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/n5nDQ4zRodY" class="underline">Oliverse - Parachute (Skybreak Remix)</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/GdbPd5HoViE" class="underline">Nejvex - Turntide</NuxtLink></li>
    </ul>
    ...
    <ul class="list-disc leading-relaxed ml-16">
      <li><NuxtLink to="https://youtu.be/48-SYWOe2dQ" class="underline">Chime - From Fairies To Fire VIP</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/zOqhHiGpt-s" class="underline">Skybreak - Locomotive VIP</NuxtLink></li>
    </ul>
    ...
    <ul class="list-disc leading-relaxed ml-16">
      <li><NuxtLink to="https://youtu.be/GsJp1ojMpLs" class="underline">INFEKT - Goofball</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/DqbAtwij31s" class="underline">Automhate - MOORG</NuxtLink> (I much prefer the second drop)</li>
    </ul>
    <p>While not a big fan of the aforementioned kinds of riddim, some artists like <NuxtLink to="https://open.spotify.com/artist/72JZ2BhMD9uBsizyfKiQEW?si=myl17pjDQXek1J9vBGdtdg" class="underline">Jorei</NuxtLink> have really taken what is often a terribly predictable subgenre and have really breathed some new life into it and created incredibly exciting and original songs that aren't even in the same league as most other riddim.</p>
    <ul class="list-disc leading-relaxed ml-16">
      <li><NuxtLink to="https://youtu.be/UuStoJvZKLU" class="underline">Jorei - Golden Bow</NuxtLink> (the dubstep starts at 1:10 haha)</li>
      <li><NuxtLink to="https://youtu.be/TAMLVHcaS8s" class="underline">Jorei - Data Link</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/N_9SbP9eAlA" class="underline">Jorei - Liella Takoyaki</NuxtLink></li>
    </ul>
    ...
    <ul class="list-disc leading-relaxed ml-16">
      <li><NuxtLink to="https://youtu.be/8gqz99Z8ET8" class="underline">MARAUDA &amp; DKKAY - FUXK 'ROUND</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/-lazqMtiSQQ" class="underline">MARAUDA - RIP</NuxtLink></li>
      <li><NuxtLink to="https://youtu.be/YDc-Jqp875o" class="underline">MARAUDA - Avoidable Cause</NuxtLink></li>
    </ul>
    <p>Here we reach the end of my little ramble about dubstep. It's truly my favorite genre of music and its variety and innovation ensures that it never gets boring for me. Hope you've enjoyed hearing about the music I love and perhaps listening to some of the songs I've provided. I'll leave you with some dubstep songs that don't nicely fit into any one of these subgenres, but I love anyway. Take care!</p>
    <ul class="list-disc leading-relaxed ml-16">
      <li><NuxtLink to="https://youtu.be/5bV7NJUqYMA" class="underline">Dyatic - Lumbre</NuxtLink> (groovy, jittery goodness in Dyatic's signature style)</li>
      <li><NuxtLink to="https://youtu.be/xQRMe11quOA" class="underline">Oliverse - Unspoken (ft. Elle Exxe)</NuxtLink> (an emotional track in a style that calls back to OG wobbly dubstep)</li>
      <li><NuxtLink to="https://youtu.be/dzHw5eV_Wf0" class="underline">Sharks - In My Eyes</NuxtLink> (extremely clean and groovy but otherwise unclassifiable)</li>
      <li><NuxtLink to="https://youtu.be/HEN751X8eQQ" class="underline">Jorei - qwiq1</NuxtLink> (crispy, crunchy, contemplative, yet aggressive)</li>
      <li><NuxtLink to="https://youtu.be/3QMWxKRv94c" class="underline">Criminal Code &amp; muyu - FLIP DOWN</NuxtLink> (jazzy, funky J-EDM awesomeness)</li>
      <li><NuxtLink to="https://youtu.be/AaNTHLZlESo" class="underline">Distayne - Far Away</NuxtLink> (a genre called "complextro" that I like sometimes; my <em>favorite song of 2021</em>)</li>
    </ul>
    <p>- NitroGuy</p>
  </div>
</template>
